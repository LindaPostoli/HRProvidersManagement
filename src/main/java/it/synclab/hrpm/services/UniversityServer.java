...
public class UniversityServer extends PersistentService<University> {

	public UniversityServer() throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		super();
	}
